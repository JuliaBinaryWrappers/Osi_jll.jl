...
const libOsiCommonTests_splitpath = ["bin", "libOsiCommonTests-1.dll"]
...
const libOsiCommonTests = "libOsiCommonTests-1.dll"


# Relative path to `libOsi`
const libOsi_splitpath = ["bin", "libOsi-1.dll"]
