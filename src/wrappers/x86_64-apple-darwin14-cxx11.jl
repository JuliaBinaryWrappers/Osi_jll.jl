# Autogenerated wrapper script for Osi_jll for x86_64-apple-darwin14-cxx11
...
const libOsiCommonTests_splitpath = ["lib", "libOsiCommonTests.1.13.5.dylib"]
...
const libOsi_splitpath = ["lib", "libOsi.1.13.5.dylib"]
