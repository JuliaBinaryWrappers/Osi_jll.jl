...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Osi_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7da25872-d9ce-5375-a4d3-7a845f58efdd"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Osi", artifacts_toml) for e in artifacts["Osi"]]
...
if best_platform === nothing
    @debug("Unable to load Osi; unsupported platform $(triplet(platform_key_abi()))")
else
